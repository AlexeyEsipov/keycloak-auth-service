...
public class UserService {
    ...
    private void deleteUserByUserAppIdInResoursesService(String appUserId) {
    ...
    public void logout(String userUUID) {
        ...
        if (Objects.nonNull(attributes)) {
            List<String> appIds = attributes.getOrDefault("app-user-id", List.of());
            if (!appIds.isEmpty()) {
                String appUserId = appIds.get(0);
                deleteUserByUserAppIdInResoursesService(appUserId);
            }
        }
